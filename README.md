...
1. Introducción a C# -> (Mayo 5)
2. Programación Orientada a Objetos (y Git/GitHub) -> (Mayo 12)
3. SQL (MS SQL Server) -> (Mayo 12)
4. API con controllers y EF Core -> (Mayo 19)
5. Seguridad en APIs -> (Mayo 26)
